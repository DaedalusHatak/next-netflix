...
<BaseInput name="Email Address" isBackground={true} type="email" complete="email" value={inputValue} error={error}   onChange={(e:any) => setInputValue(e.target.value)} required></BaseInput>
      </div>
